...
namespace ProjProcessOrders.Localization.Localizations
{
    public class Resources
    {
        ...
        public string ClientAlreadyExists() => _localizer[nameof(ClientAlreadyExists)];
        public string ProductNotExists() => _localizer[nameof(ProductNotExists)];
        public string ProductHasOrders() => _localizer[nameof(ProductHasOrders)];
        public string OrderNotExists() => _localizer[nameof(OrderNotExists)];
        public string DuplicateProduct() => _localizer[nameof(DuplicateProduct)];
